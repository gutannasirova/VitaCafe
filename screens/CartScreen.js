...
const CartScreen = ({ navigation }) => {
    ...
    // Уменьшение количества товара (с удалением при достижении 0)
        ...
        <ImageBackground source={require("./assets/fon.png")} style={styles.background}>
            <View style={styles.container}>
                ...
                <FlatList
                    ...
                    ItemSeparatorComponent={() => <View style={styles.separator} />} // Отступы между товарами
                />

                {/* Итог и кнопка "Заказать" */}
...
const styles = StyleSheet.create({
    background: {
        flex: 1,
        resizeMode: "cover", // Растягиваем изображение на весь экран
    },
    container: {
        flex: 1,
        padding: 10,
    ...
    separator: {
        height: 20, // Отступ между товарами
    },
    totalContainer: {
        flexDirection: "row",
        justifyContent: "space-between",
